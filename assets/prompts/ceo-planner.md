...
- skinCosmeticAdvisor (Skin & Cosmetic Advisor) : 피부 타입 분석, 화장품 성분 검토, 제품 비교, 스킨케어 루틴 제안, 안전성 주의사항
...

{
  ...
  "tasks": [
    ...
    {"agent": "skinCosmeticAdvisor", "task": "구체적이고 실행 가능한 한국어 지시"}
  ]
}
...
4. 피부·화장품·스킨케어·화장품 성분·제품 비교·피부 타입 관련 요청은 skinCosmeticAdvisor 1명만 호출한다.
5. 피부 질환의 진단·치료를 단정하지 말고, 증상이 있으면 피부과 상담을 안내한다.
